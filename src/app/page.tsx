      ...
      <div className="container mx-auto px-4 py-8 max-w-5xl">
        ...
        <div className={`transition-all duration-300 delay-200 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}>
          <DropdownMenu 
            ...
            icon="📄"
            className="bg-white border border-gray-200 hover:border-gray-300 hover:bg-gray-50 border-l-4 border-l-blue-600 p-4 rounded-md"
          >
        ...
        <div className={`transition-all duration-300 delay-400 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}>
          <LinkCard 
            href="/obligaciones-especificas-municipios" 
            text="Obligaciones específicas de los municipios"
            icon="🏛️"
            className="hover:bg-gray-50 transition-all bg-white border border-gray-200 hover:border-gray-300 border-l-4 border-l-blue-600 p-4 rounded-md"
          />
        </div>
